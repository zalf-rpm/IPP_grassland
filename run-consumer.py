...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    output_grids = {
        ...
        "Mois_06-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "N2O_06-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "NLeach_06-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Eto_06-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Pot_ET_06-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "CutBiomass_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "AbBiom_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "SOC_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Mois_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Eto_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Pot_ET_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "N2O_08-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        ...
        "Mois_10-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},        
        "Eto_10-15": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
